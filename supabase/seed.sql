...
inserted_customers AS (
    ...
    ('coach house 1', '', 'park avenue', 'st ives', 'tr262dn', 'uk', '', 'orange roofs', 0, (select id from inserted_groups where group_name = 'orange roofs')),
    ('coach house 2', '', 'park avenue', 'st ives', 'tr262dn', 'uk', '', 'orange roofs', 0, (select id from inserted_groups where group_name = 'orange roofs')),
